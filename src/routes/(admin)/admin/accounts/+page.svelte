<script lang="ts">
	...
	import { closeModalById, closeTopModal, openModal } from "$lib/modalManager.svelte";
	...
	let userManageModalId: string;

	function openInviteModal() {
		openModal(inviteModal, "snippet", "center")
	}
	function openUserManageModal() {
		userManageModalId = openModal(userManageModal, "snippet", "right")
	}

	function closeUserManageModal() {
		closeModalById(userManageModalId)
	}
</script>
...
{#snippet userManageModal()}
	<div class="admin-modal-content right-modal">
		...
		<LoadingButton
			classes="admin-button admin-modal-action-button"
			loading={userLoading}
			onclick={saveUserChanges}>Save</LoadingButton
		>
		<div class="admin-editor-column admin-editor-column-noborder admin-editor-sidebar-inner">
