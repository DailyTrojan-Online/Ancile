<script lang="ts">
	...
	async function loadCategories() {
		let countQuery = supabase.from("categories").select("count");
		if (searchQuery != "") {
...
<div class="admin-page-content">
	<div class="admin-page-header">
		<div class="admin-buttons">
			...
			{:else}
				...
				<Pagination {pageCount} onChange={pageChange} bind:page></Pagination>
				<input
	...
	<div class="admin-editor">
		...
		<div class="admin-editor-column">
			...
			{#if editCategory}
				<div class="flex-hor">
					<button class="admin-button button-primary" onclick={updateCategory}
						>Update</button
					>
					<button class="admin-button button-sub" onclick={cancelEditCategory}
						>Cancel</button
					>
				</div>
			{:else}
				<div class="flex-hor">
					<button class="admin-button button-primary" onclick={newCategory}
						>Add</button
					>
				</div>
			{/if}
